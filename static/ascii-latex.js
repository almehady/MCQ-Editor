...
function convertMyAsciiToLatex(myAsciiMathString){
    const asciimath = myAsciiMathString
    const latex = asciimath2latex(asciimath)
    return latex;
}

window.convertMyAsciiToLatex = convertMyAsciiToLatex

// const mAsc = '2=(((3-x)xx2)/(3-x))';
// console.log(`my asciimath: ${mAsc}`)
// const converted = convertMyAsciiToLatex(mAsc)
// console.log("latex string")
// console.log(converted)

module.exports ={
    convertMyAsciiToLatex
}

},{"asciimath-to-latex":2}],2:[function(require,module,exports){
var config = {
